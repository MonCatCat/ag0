...
import (
	...
	"github.com/MonCatCat/ag0/v7/app/params"
)
...
Example:
	ag0 testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "agoric", "Home directory of the node's daemon configuration")
